...
public class NetworkTraffic extends TextView implements TunerService.Tunable,
    ...
    private final NetworkTrafficHandler mTrafficHandler;

    private static final RelativeSizeSpan mSpeedRelativeSizeSpan = new RelativeSizeSpan(0.70f);
    private static final RelativeSizeSpan mUnitRelativeSizeSpan = new RelativeSizeSpan(0.65f);

    private boolean mEnabled = false;
    private boolean mConnectionAvailable = true;

    private static final HashMap<Network, LinkProperties> mLinkPropertiesMap = new HashMap<>();
    ...
    public NetworkTraffic(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTrafficHandler = new NetworkTrafficHandler(mContext.getMainLooper());
    }

    private final class NetworkTrafficHandler extends Handler {
        public NetworkTrafficHandler(Looper looper) {
            super(looper);
        }
    ...
    private ConnectivityManager.NetworkCallback mNetworkCallback =
            new ConnectivityManager.NetworkCallback() {
                ...
                public void onLinkPropertiesChanged(Network network,
                    ...
                    if (mTrafficHandler == null) return;
    ...
    protected void onAttachedToWindow() {
        ...
        mContext.registerReceiver(mIntentReceiver, filter, null, (Handler) mTrafficHandler);
    ...
    private void checkUpdateTrafficDrawable() {
        ...
        if (!mVisible || mIconTint == newTint) return;
        mIconTint = newTint;
