...
class FaceUnlockImageView @JvmOverloads constructor(
    ...
    fun updateColor() {
        ...
        val themedContext: Context = ContextThemeWrapper(context,
                com.android.internal.R.style.Theme_DeviceDefault_DayNight)
        var themedTextColorSecondary: Int = themedContext.obtainStyledAttributes(
                    IntArray(1) {com.android.internal.R.attr.textColorSecondary}).getColor(0, 0)
        imageTintList = if (this.id == R.id.bouncer_face_unlock_icon) {
            ...
            ColorStateList.valueOf(themedTextColorSecondary)
        }
    }
