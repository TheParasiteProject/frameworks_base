...
public class PackageManagerService implements PackageSender, TestUtilityService {
    ...
    public PackageManagerService(PackageManagerServiceInjector injector, boolean factoryTest,
        ...
        synchronized (mLock) {
            ...
            enableComponents(mContext.getResources().getStringArray(
                    org.lineageos.platform.internal.R.array.config_deviceDisabledComponents), false);
            enableComponents(mContext.getResources().getStringArray(
                    org.lineageos.platform.internal.R.array.config_globallyDisabledComponents), false);

            // Enable components marked for forced-enable at build-time
            enableComponents(mContext.getResources().getStringArray(
                    org.lineageos.platform.internal.R.array.config_forceEnabledComponents), true);
    ...
    private String getRequiredServicesExtensionPackageLPr(@NonNull Computer computer) {
        String servicesExtensionPackage = mContext.getString(R.string.config_servicesExtensionPackage);
