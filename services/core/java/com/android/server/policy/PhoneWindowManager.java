...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private void backLongPress() {
        ...
        if (mHasNavigationBar || !hasLongPressOnBackBehavior()){
            return;
        }
    ...
    private class DisplayHomeButtonHandler {
        ...
        boolean handleHomeButton(IBinder focusedToken, KeyEvent event) {
            ...
            if (!down) {
                if (mDisplayId == DEFAULT_DISPLAY && (fromNavbar || mHomeDoubleTapAction != Action.APP_SWITCH)) {
            ...
            if (repeatCount == 0) {
                mHomePressed = true;
                if (!fromNavbar && mPendingHomeKeyEvent != null) {
                    mPendingHomeKeyEvent = null;
    ...
    private void updateKeyAssignments() {
        ...
        mAssistPressAction = Action.fromIntSafe(res.getInteger(
                org.lineageos.platform.internal.R.integer.config_pressOnAssistBehavior));
    ...
    private boolean interceptSystemKeysAndShortcuts(IBinder focusedToken, KeyEvent event) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_MENU:
                ...
                if (deviceId == KeyCharacterMap.VIRTUAL_KEYBOARD || keyguardOn) {
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags) {
        ...
        boolean useHapticFeedback = down
                ...
                && (!isNavBarVirtKey || mNavBarVirtualKeyHapticFeedbackEnabled || (!mHasNavigationBar && !fromNavbar && !virtualKey))
                && event.getRepeatCount() == 0;
                ...
                if (down) {
                    ...
                    if (mIsLongPress && mCameraLaunch) {
                        ...
                        if (!isAlreadyRunning(intent)) {
                            isWakeKey = true;
                            performHapticFeedback(HapticFeedbackConstants.LONG_PRESS, true, "Camera key - Launch Camera");
                            startActivityAsUser(intent, UserHandle.CURRENT_OR_SELF);
                        }
                    }
                }
    ...
    private void sendLidChangeBroadcast() {
        ...
        Intent intent = new Intent(com.android.internal.custom.content.Intent.ACTION_LID_STATE_CHANGED);
        intent.putExtra(com.android.internal.custom.content.Intent.EXTRA_LID_STATE, lidState);
