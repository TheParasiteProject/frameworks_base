...
public class CutoutUtils {
    ...
    public static boolean hasCutout(Context context, boolean ignoreCutoutMasked) {
        boolean hasCutout = context.getResources().getBoolean(org.lineageos.platform.internal.R.bool.config_physicalDisplayCutout);
    ...
    public static boolean hasCenteredCutout(Context context, boolean ignoreCutoutMasked) {
        ...
        boolean hasCenteredCutout = context.getResources().getBoolean(org.lineageos.platform.internal.R.bool.config_physicalDisplayCutoutCentered);
